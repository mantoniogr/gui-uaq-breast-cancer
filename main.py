...
class Example(wx.Frame):
    ...
    def OnThreshold(self, e):
        ...
        self.image = f.threshold_2(self.image, 255)
        cv2.imshow('Image', self.image)
        self.statusbar.SetStatusText('Listo')
    ...
    def OnAnalysis(self, e):
        ...
        th, image_umbral = cv2.threshold(self.image, 2, 255, cv2.THRESH_BINARY)
...
class Example(wx.Frame):
    ...
    def OnThermogram(self, e):
        if self.path:
            ...
            self.t_r = f.thermogram(self.image, self.t_max, self.t_min)
